...
<template>
    <div class="flex flex-row justify-between py-8 px-4 font-bold bg-azure-radiance-600 text-white items-center">
        <p class="text-3xl">NOTES</p>
        <button @click="clicked = !clicked" class="cursor-pointer hover:bg-black/10 rounded-md p-2">
